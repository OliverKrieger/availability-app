    ...
    return (
        <button
            ...
            className={[
                ...
                inMonth
                    ...
                    : "border-zinc-900 bg-zinc-950/40 text-zinc-600 hover:bg-zinc-950/60",
        ...
        >
            <div className="flex items-start justify-between">
                ...
                {topRightBadge ? (
                    <div className="rounded-lg border border-zinc-800 bg-zinc-950/40 px-2 py-1 text-[10px] text-zinc-300">
                        {topRightBadge}
                    </div>
                ) : null}
            </div>
            ...
            <div className="mt-auto">
                {bottomText ? (
                    <div className="text-xs text-zinc-400 group-hover:text-zinc-300">{bottomText}</div>
                ) : (
                    <div className="text-xs text-zinc-600">{inMonth ? "Busy (default)" : ""}</div>
                )}
            </div>
        </button>
    );
